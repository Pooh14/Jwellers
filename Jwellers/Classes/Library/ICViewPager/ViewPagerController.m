...
#define kTabOffset 150.0
#define kTabWidth 250.0
...
#define kTabsViewBackgroundColor [UIColor colorWithRed:234.0/255.0 green:234.0/255.0 blue:234.0/255.0 alpha:1.0]
...
- (void)setTabWidth:(NSNumber *)tabWidth {
    ...
    _tabWidth = tabWidth;
//    _tabWidth = [NSNumber numberWithFloat:150.0];
}
